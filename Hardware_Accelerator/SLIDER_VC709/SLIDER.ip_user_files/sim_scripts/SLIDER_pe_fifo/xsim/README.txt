...
#
# Generated by export_simulation on Fri Sep 14 12:40:47 +0300 2018
#
################################################################################
...
switch to the './SLIDER_pe_fifo.sh' script.

./SLIDER_pe_fifo.sh -reset_run
...
./SLIDER_pe_fifo.sh -noclean_files

For more information on the script, please type './SLIDER_pe_fifo.sh -help'.
